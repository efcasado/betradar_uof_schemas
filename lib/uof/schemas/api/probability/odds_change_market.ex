defmodule UOF.Schemas.API.Probability.OddsChangeMarket do
  @moduledoc false
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one(:market_metadata, UOF.Schemas.API.Probability.MarketMetadata)
    embeds_many(:outcome, UOF.Schemas.API.Probability.OddsChangeMarketOutcome)
  end
