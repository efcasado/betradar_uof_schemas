defmodule UOF.Schemas.API.Probability.SportEventStatus do
  @moduledoc false
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one(:clock, UOF.Schemas.API.Probability.Clock)
    embeds_one(:period_scores, UOF.Schemas.API.Probability.Periodscores)
    embeds_one(:results, UOF.Schemas.API.Probability.Results)
    embeds_one(:statistics, UOF.Schemas.API.Probability.Statistics)
  end
