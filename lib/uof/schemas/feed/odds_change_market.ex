defmodule UOF.Schemas.Feed.OddsChangeMarket do
  @moduledoc false
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one(:market_metadata, UOF.Schemas.Feed.MarketMetadata)
    embeds_many(:outcome, UOF.Schemas.Feed.OddsChangeMarketOutcome)
  end
