defmodule UOF.Schemas.Feed.SportEventStatus do
  @moduledoc false
  use Ecto.Schema
  ...
  embedded_schema do
    ...
    embeds_one(:clock, UOF.Schemas.Feed.Clock)
    embeds_one(:period_scores, UOF.Schemas.Feed.Periodscores)
    embeds_one(:results, UOF.Schemas.Feed.Results)
    embeds_one(:statistics, UOF.Schemas.Feed.Statistics)
  end
