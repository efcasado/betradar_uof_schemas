defmodule Mix.UOF.Schemas.XSD.Generator do
  @moduledoc """
  Turns the `Mix.UOF.Schemas.XSD` intermediate representation into Ecto
  ...
  alias Mix.UOF.Schemas.XSD.ComplexType
  alias Mix.UOF.Schemas.XSD.Element
